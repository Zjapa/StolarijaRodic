...
const page = ({ params }) => {
  ...
  return (
    <section className="service-page-item">
        ...
        <>
          <div className="container service-page-item-wrapper">
            <div className="service-page-content">
              {uslugaContent.imageTop && (
                <Image
                  src="images/velux/VeluxOpsta1.png"
                  alt="Velux ovlasceni prodavac"
                  className="image-top"
                  height={350}
                  width={650}
                />
              )}
              <h3 className="service-page-item-subtitle">
                {uslugaContent.title}
              </h3>
              ...
              {uslugaContent.imageBottom && (
                <Image
                  src="images/velux/VeluxOpsta2.png"
                  alt="Velux ovlasceni prodavac"
                  className="image-top"
                  height={350}
                  width={650}
              ...
              <div className="velux-service-content">
                {uslugaContent.imageGrid?.map((img, index) => (
                  <Image
                    key={img}
                    src={img}
                    height={300}
      ...
      {veluxUslugaContent && (
        <VeluxPageContent veluxUslugaContent={veluxUslugaContent} url={url} />
      )}
    </section>
  );
};
